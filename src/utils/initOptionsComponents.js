...
function main(app, name, catalogue) {
	try {
		let template = (require(`@/components/${catalogue}/options/${name}`) || {}).default
		// let template = (await import(`@/components/element/options/${name}`)).default
