	...
	<div>
		<el-form label-width="70px" label-position="left">
			...
			<el-form-item label="颜色">
				<el-color-picker @active-change="selectTextColor" v-model="data.textColor" show-alpha />
			</el-form-item>
			...
			<el-form-item label="背景色">
				<el-color-picker @active-change="selectBgColor" v-model="data.bgColor" show-alpha />
			</el-form-item>
			<el-form-item label="文字大小">
				<el-input-number :min="13" :max="200" v-model="data.textSize" style="width: 100%" />
			</el-form-item>
			<el-form-item label="行高">
				<el-input-number :min="13" :max="250" v-model="data.textLineHeight" style="width: 100%" />
			</el-form-item>
			...
			<el-form-item label="下划线">
				<el-select v-model="data.textDecoration">
					<el-option v-for="(item,index) in textDecorationList" :key="index+item.label" :label="item.label"
						:value="item.value" />
				</el-select>
			</el-form-item>
			<el-form-item>
				...
				<!-- </span> -->
				<el-input type="textarea" :rows="3" v-model="data.url"></el-input>
			</el-form-item>
		</el-form>
	</div>
</template>
