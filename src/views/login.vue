	...
	<div>
		<div class="bg">
			<div class="login_main">
				<div class="tab">
					<text :class="{active:this.active}" @click="this.active = true">密码登录</text>
					<text :class="{active:!this.active}" @click="this.active = false">免费注册</text>
				</div>

				<el-form class="from" :model="loginForm" :rules="rules" ref="login" label-width="0">
				...
				<div class="btn">
					<el-button style="width: 100%;height: 40px;" type="primary" @click="submitForm">
						{{active?'登录':'注册'}}
					</el-button>
				</div>
			</div>
